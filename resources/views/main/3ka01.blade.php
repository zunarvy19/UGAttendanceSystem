          ...
          <div>
              <div class="flex justify-between">
                  <div class="flex items-center">
                      <h1 class=" flex mb-4 text-lg font-semibold">Total Mahasiswa :&nbsp;<span>{{$total3ka01}}</span></h1>
                  </div>
                  <div>
                    <form action="/view3ka01">
                        @csrf
                        ...
                        <div class="relative mb-4 ">
                            ...
                            <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-secondary hover:bg-opacity-75 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2">Cari</button>
                    </form>
                      </div>
                  </div>
              </div>                                                    
